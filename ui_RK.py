...
class UIButtonRK:
    ...
    def handle_event_RK(self, event):
...
class UIOverlayRK:
    ...
    def draw_hud_RK(self, screen, gold, lives, wave_idx, wave_active, finished):
